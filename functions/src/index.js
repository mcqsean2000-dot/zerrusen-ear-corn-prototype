...
function routeRequest(req, res, options = {}) {
  ...
  if (path === "/api/admin/social-posts/reconciliation") {
    return adminSocialReconciliationHandler(req, res, options);
  }

  if (path === "/api/admin/social-posts/reconciliation/resolve") {
