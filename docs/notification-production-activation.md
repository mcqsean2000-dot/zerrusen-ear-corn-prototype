...
2. Verify the approved sending domain in Resend and approve the exact `NOTIFICATION_FROM_EMAIL` address.
3. Keep `NOTIFICATION_REPLY_TO=theosfeedfarm@gmail.com` unless the client approves another monitored inbox.
...
NOTIFICATION_FROM_EMAIL=replace-with-approved-verified-sender
